    ...
    <div className="flex flex-grow flex-col justify-center">
      ...
      <div className="centered flex justify-center bottom-0 px-4 py-2">
        <div className="icon px-2">
          <a href="mailto:nosretepea@gmail.com"><img className="h-full" src={MailLight} alt="email" /></a>
        </div>
        <div className="icon px-2">
          <a href="https://www.linkedin.com/in/ashley-peterson-24387814a/"><img className="h-full" src={LinkedinLight} alt="linkedin" /></a>
        </div>
        <div className="icon px-2">
          <a href="https://www.github.com/nosretepea"><img className="h-full" src={GithubLight} alt="github" /></a>
        </div>
      </div>
    </div>
  )
